...
// Cambiar imagen para el elemento "graficos" según ancho de pantalla
    ...
    const pozoMob = 'pozoProfMob.svg';    // <- imagen Pozo mobile
...
controlDiv.onAdd = function () {
  ...
  d.innerHTML = `<div>
     <div id="filtros">
        ...
        <button id="btnReset" class="btn"><span class='verT'>Ver t</span><span class='t'>T</span>odos los yacimientos</button>
        <div id="refes">
          <p><span>+</span> POZOS</p>
...
controlDivMob.onAdd = function () {
  ...
  dMob.innerHTML = `<div>
     <div id="filtrosMob">
        ...
        <button id="btnReset" class="btn"><span class='verT'>Ver t</span><span class='t'>T</span>odos los yacimientos</button></div>
        <div id="refes">
          <p><span>+</span> POZOS</p>
          <div class="refContainer">
            <div class="refYPF"></div>
